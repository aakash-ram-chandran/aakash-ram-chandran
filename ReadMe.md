...
**Research:** RL-based combinatorial optimization (DQN, PPO, Transformer-GNN 
...
**ML & Research:** PyTorch | Reinforcement Learning | Transformers | GNNs | 
CNNs | Imitation Learning | OpenCV | Open3D

**Deployment:** TensorRT | ONNX | Triton | GCP Vertex AI | Docker

**MLOps:** MLflow | InfluxDB | Grafana | Label Studio | CI/CD
